...
require '../init.php';
$langType = "ar";
 $class = $langType == 'en' ? 'introEn' : 'intro';
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu colorOption">
                                    <li data-value='../layout/css/red_theme.css'><a><i class="fa  fa-fw"></i> </a></li>
                                    <li data-value='../layout/css/green_theme.css'><a><i class="fa  fa-fw"></i></a></li>
                                    <li data-value='../layout/css/blue_theme.css'><a><i class="fa  fa-fw"></i></a></li>
                                    <li data-value='../layout/css/yellow_theme.css'><a><i class="fa  fa-fw"></i></a></li>
                                </ul>
                            </li>
                ...
                <div class="col-md-8 text-center">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            ...
                            <span data-wow-delay="1s" class="wow slideInRight animated text"> <?php echo lang('MOBILE')?> </span>
                        </li>
                        <li>
                            <label class="wow slideInRight animated text"><i class="fa fa-envelope-square fa-fw"></i>  <?php echo lang('VIAEMAIL') ?> :</label>
                            <span data-wow-delay="1s" class="wow slideInRight animated text"> <?php echo lang('EMAIL')?> </span>
                        </li>
                        <li>
                            <label class="wow text slideInRight animated"><i class="fa fa-map-marker fa-fw"></i> <?php echo lang('VIAADDRESS') ?>:</label>
                            <span data-wow-delay="1s" class="wow text slideInRight animated"> 
